...
df5000credits = pd.read_csv('app/data/5000/tmdb_5000_credits.csv',low_memory=False)
df5000movies = pd.read_csv('app/data/5000/tmdb_5000_movies.csv',low_memory=False)
df6820movies = pd.read_csv('app/data/6820/movies.csv',low_memory=False)
...
# app\data\5000\tmdb_5000_credits.csv